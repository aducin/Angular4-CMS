...
export class OrderListComponent implements OnInit {
  ...
  constructor(private mainData: MainData, private route: ActivatedRoute, private router: Router, private service: OrderService) {}

  ngOnInit() {
    this.serverPath = this.mainData.serverPath;
                  ...
                  if (data.success === false) {
                    ...
                    if (this.lastVoucher === 0) {
                      this.service.setMessage({
                        type: 'error',
                        text: this.mainData.emptyVoucher,
                      });
                    }
                  }
                });
